...
*PARAMETROS DO MODELO DO GERADOR DIESEL (consumo)
  Scalar a parametro para modelagem do consumo;
...
*;
*Table tarifas_demandas(tdia, thora) multa por kW excedente; -- TABLES CANNOT BE LOADED DYNAMICALLY
Parameter tarifas_demandas(tdia, thora) multa por kW excedente;
